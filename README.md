...
- **Step 9:** Open the directory where the data files are present and select them to upload them to your Google Drive.
...
- **Step 10:** To download the data to your colab, go to your Google drive and right click on the the **"tsd_train.csv"** data file. Select **"Get link"** in the right-click options
...
- **Step 11:** A new window **"Get link"** will be opened. Copy the highlighted portion which represents the file id of tsd_train.csv file.
...
- **Step 12:** Paste the copied file id contents in colab file under **"Download the train, trial and test data file"** section
...
- **Step 13:** Repeat **Step 5, Step 6 and Step 7** for trial(tsd_trial.csv) and test(tsd_test.csv) data files
- **Step 14:** To run the model, first change the Runtime type to **GPU**.
 <br/>
 ...
 - **Step 15:** Select **"Run all"** option to execute the code
 ...
 - **Step 16:** When the cell corresponding Mount to Drive is executed, we need to provide a verification code.
 ...
 - **Step 17:** Select the account to sign in.
